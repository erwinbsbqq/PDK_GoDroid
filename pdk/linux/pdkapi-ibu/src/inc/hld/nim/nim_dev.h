...
enum nim_device_ioctrl_command
{
    ...
    NIM_DRIVER_SEARCH_T2_SIGNAL_ONLY,    //!< set search T2 signal only when autoscan 0:combo search 1:signal only  
    NIM_DRIVER_TURNER_SET_LT,            //!< set tuner only loopthrough function enable or disable 
};
