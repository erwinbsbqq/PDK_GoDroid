...
struct dmx_device
{
    ...
    UINT8 *dmx_linux_dev_path;
    UINT8 *frame_buf_linux_dev_path;
    UINT8 *decv_linux_dev_path;
    UINT8 *deca_linux_dev_path;

    INT32 framebuf_linux_fd;
    INT32 decv_linux_fd;
    INT32 deca_linux_fd;

    INT32 dmx_linux_v_flt_fd;
    INT32 dmx_linux_a_flt_fd;
    INT32 dmx_linux_p_flt_fd;

    UINT16 dmx_linux_v_flt_pid;
    UINT16 dmx_linux_a_flt_pid;
    UINT16 dmx_linux_p_flt_pid;

    enum DMX_AV_STATUS av_status;
};
