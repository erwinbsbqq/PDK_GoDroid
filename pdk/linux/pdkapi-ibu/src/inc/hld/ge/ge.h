 ...
 enum GE_ROP_MODE
{
	...
	GE_ROP_BOOL_ALPHA_BLEND,// Only color are operated by boolean operation,Alpha is operated by alpha-blending
	GE_ROP_DFB_BLEND                                
};
...
typedef struct _hw_cmd_buffer
{
    BOOL   bIsLQ;           //TRUE:LQ,FALSE:HQ
    UINT32 *pBuffer;        //the cmd buffer,aligned withe DW
    UINT32 nBufferLen;     //the buffer size in DW,at lease 30K
}ge_hw_cmd_buffer;
...
enum GE_PREMULTIPLY_SEL
{
	GE_DISABLE_PREMULTIPLY,
	GE_USE_PREMULTIPLY,
};
...
enum GE_PTN_BLEND_MODE
{
    PTN_DSBF_UNKNOWN,
    PTN_DSBF_ZERO,
    PTN_DSBF_ONE,
    PTN_DSBF_SRCCOLOR,
    PTN_DSBF_INVSRCCOLOR,
    PTN_DSBF_SRCALPHA,
    PTN_DSBF_INVSRCALPHA,
    PTN_DSBF_DESTALPHA,
    PTN_DSBF_INVDESTALPHA,
    PTN_DSBF_DESTCOLOR,
    PTN_DSBF_INVDESTCOLOR,
    PTN_DSBF_SRCALPHASAT,
};

enum GE_SRC_BLEND_MODE
{
    SRC_DSBF_UNKNOWN,
    SRC_DSBF_ZERO,
    SRC_DSBF_ONE,
    SRC_DSBF_SRCCOLOR,
    SRC_DSBF_INVSRCCOLOR,
    SRC_DSBF_SRCALPHA,
    SRC_DSBF_INVSRCALPHA,
    SRC_DSBF_DESTALPHA,
    SRC_DSBF_INVDESTALPHA,
    SRC_DSBF_DESTCOLOR,
    SRC_DSBF_INVDESTCOLOR,
    SRC_DSBF_SRCALPHASAT,
};
...
/* add end*/
    ...
    RET_CODE (*set_dfb_global_color)(struct ge_device * , UINT32 , UINT32 );
    RET_CODE (*set_ptn_modulate_mode)(struct ge_device * , UINT32 , UINT32 );
    RET_CODE (*set_src_premultiply)(struct ge_device * , UINT32 , enum GE_PREMULTIPLY_SEL );
    RET_CODE (*set_ptn_premultiply)(struct ge_device * , UINT32 , enum GE_PREMULTIPLY_SEL );
    RET_CODE (*set_ptn_premult_color)(struct ge_device * , UINT32 , enum GE_PREMULTIPLY_SEL );
    RET_CODE (*set_ptn_blend_mode)(struct ge_device * , UINT32 , enum GE_PTN_BLEND_MODE );
    RET_CODE (*set_src_blend_mode)(struct ge_device * , UINT32 , enum GE_SRC_BLEND_MODE );
    RET_CODE (*set_dst_demultiply)(struct ge_device * , UINT32 , enum GE_PREMULTIPLY_SEL );
    RET_CODE (*set_dst_xor)(struct ge_device * , UINT32 , BOOL );
