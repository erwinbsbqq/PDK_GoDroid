...
ER OS_WaitFlagTimeOut(UINT *, ID, UINT, UINT, TMO,char *,int);
#else
...
//Special Interface
#define OS_AcquireSemaphore(A)		OS_AcquireSemaphoreTimeOut(A,TMO_FEVR,__FUNCTION__,__LINE__)
#else
...
#ifdef APP_LOCK_DEBUG  /* --Doy.Dong, 2013-1-15*/
ER OS_GetMsgTimeOut(VP, INT *, ID, TMO,char*,int);
#else
...
//core#include <api/libc/printf.h>
