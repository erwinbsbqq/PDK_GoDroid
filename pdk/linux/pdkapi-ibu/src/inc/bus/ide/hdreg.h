...
#define HDIO_DRIVE_CMD_HDR_SIZE		(4 * sizeof(UINT8))
#define HDIO_DRIVE_HOB_HDR_SIZE		(8 * sizeof(UINT8))
#define HDIO_DRIVE_TASK_HDR_SIZE	(8 * sizeof(UINT8))
