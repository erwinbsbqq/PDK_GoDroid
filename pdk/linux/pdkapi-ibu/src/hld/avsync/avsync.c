...
#define MUTEX_LOCK()   ipc_semlock(g_avsync_mutex_id)
#define MUTEX_UNLOCK() ipc_semunlock(g_avsync_mutex_id)
#endif
...
#ifdef ADR_IPC_ENABLE
	g_avsync_mutex_id = ipc_semget(ADR_IPC_AVSYNC, 0, 1);
