...
#define FT_TOUCH_X_H_POS		5
#define FT_TOUCH_X_L_POS		6
#define FT_TOUCH_Y_H_POS		7
#define FT_TOUCH_Y_L_POS		8
#define FT_TOUCH_EVENT_POS		5
#define FT_TOUCH_ID_POS			7
