...
/**************** decv *******************/
    ...
    PARAM_Vdecinit_rpc,
    PARAM_Vdec_playback_param_rpc,
    PARAM_Vdec_capture_frm_info_rpc,
...
/**************** dsc ******************/    
    ...
    PARAM_Sha_hash_rpc,
    PARAM_Trng_data_rpc,
    PARAM_Dsc_deen_parity_rpc,
    PARAM_Dsc_drv_ver_rpc,
    PARAM_Dsc_ver_chk_param_rpc,
...
typedef struct audio_decore_status_rpc
{
    Uint32 sample_rate;
    Uint32 channels;
...
typedef struct vdec_capture_frm_info_rpc
{
    UINT32 pic_height;
    UINT32 pic_width;
    UINT32 pic_stride;
...
typedef enum vdec_playback_rate_rpc
{
    VDEC_RATE_1_2_r,
    VDEC_RATE_1_4_r,
    VDEC_RATE_1_8_r,
...
typedef enum vdec_playback_dir_rpc
{
    VDEC_PLAY_FORWARD_r = 0,
    VDEC_PLAY_BACKWARD_r,
};

typedef struct vdec_playback_param_rpc
{
    enum vdec_playback_dir_rpc direction;
    enum vdec_playback_rate_rpc rate;
}Vdec_playback_param_rpc;
...
typedef struct Dsc_pvr_key_param_rpc
{
	...
	Uint16 stream_id;
	Uchar pvr_first_key_pos;
}Dsc_pvr_key_param_rpc;

typedef struct dsc_en_priority_rpc
{
	Uint32 sub_module;
	Uint32 priority;
	Uint32 dev_ptr;
...
typedef struct drv_version_rpc
{
    Uchar data[20];
}Dsc_drv_ver_rpc;

typedef struct dsc_ver_check_rpc
{
	unsigned int input_mem;
	unsigned int len;
	unsigned int chk_mode; 
	unsigned int chk_id;
}Dsc_ver_chk_param_rpc;
