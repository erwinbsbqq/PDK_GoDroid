...
#define ALI_IRQ_USB1_EHCI     (4+32+8)	/*int reg2 bit4*/
#define ALI_IRQ_USB1_OHCI     (18+32+8)/*int reg2 bit18*/
#define ALI_IRQ_USB_GADGET   (29+8) 	/*int reg1 bit29*/
...
#define HDMI_EDDC_SDA     22
#define HDMI_EDDC_SCL     23
