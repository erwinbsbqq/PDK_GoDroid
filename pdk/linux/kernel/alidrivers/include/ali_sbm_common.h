...
struct sbm_desc{
	 ...
	 * Add by Joy, date:2014.10.08
	*/
	unsigned int request_write_total_cnt;
	unsigned int request_write_status_err_cnt;
	unsigned int request_write_full_cnt;
	unsigned int request_write_ok_cnt;
	unsigned int update_write_total_cnt;
	unsigned int update_write_status_err_cnt;	
	unsigned int update_write_ok_cnt;

	unsigned int request_read_total_cnt;
	unsigned int request_read_status_err_cnt;	
	unsigned int request_read_ok_cnt;
	unsigned int request_read_empty_cnt;
	unsigned int update_read_total_cnt;
	unsigned int update_read_status_err_cnt;	
	unsigned int update_read_ok_cnt;

	unsigned int pkt_write_total_cnt;
	unsigned int pkt_write_status_copy_from_user_err_cnt;
	unsigned int pkt_write_full_cnt;
	unsigned int pkt_write_ok_cnt;	
};
...
struct sbm_desc_pkt{
	...
	*/
	...
	unsigned int pkt_write_full_cnt;
	unsigned int pkt_write_ok_cnt;	
	unsigned int pkt_write_status_err_cnt;
};
