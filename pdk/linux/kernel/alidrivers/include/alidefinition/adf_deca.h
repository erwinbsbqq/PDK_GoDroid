...
/*ALI audio sub IO command for DECA */
...
#define DECA_PTS_DELAY                          (DECA_CMD_BASE + 69)
...
#define DECA_CHANGE_AUD_TRACK                   (DECA_CMD_BASE + 94)
...
#define DECA_IO_GET_INPUT_CALLBACK_ROUTINE      (DECA_ADV_IO + 14)
#define DECA_SET_AVSYNC_TEST                    (DECA_ADV_IO + 15)
#define DECA_SET_PTS_SHIFT                      (DECA_ADV_IO + 16)
