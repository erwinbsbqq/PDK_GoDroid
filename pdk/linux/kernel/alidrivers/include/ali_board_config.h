...
#else
extern unsigned long __G_ALI_MM_SUBT_SIZE;
extern unsigned long __G_ALI_MM_SUBT_START_ADDR;

extern unsigned long __G_ALI_MM_TTX_SIZE;
extern unsigned long __G_ALI_MM_TTX_START_ADDR;

extern unsigned long __G_ALI_MM_TTX_PARAM_BUF_SIZE;
...
extern unsigned long __G_ALI_MM_ALSA_CAPTURE_MEM_SIZE;
extern unsigned long __G_ALI_MM_ALSA_CAPTURE_START_ADDR;
...
/* DVFS I2C device id number,  DVFS module access the voltage regulator based on the  I2C device id */

extern long g_dvfs_i2c_device_id;

/* DVFS I2C device id number definition end */
...
// lcd gpio
extern unsigned long g_lcd_backlight_gpio;
extern unsigned long g_lcd_reset_gpio;

/* gpio i2c */
extern unsigned int g_gpio_i2c_panel_id;
extern unsigned int g_gpio_i2c_panel_sda;
extern unsigned int g_gpio_i2c_panel_scl;

//panel CH455 and CH454 LED address
extern unsigned char g_dig0_addr;
extern unsigned char g_dig1_addr;
extern unsigned char g_dig2_addr;
extern unsigned char g_dig3_addr;
extern unsigned char g_dig4_addr;
extern unsigned char g_dig0_high_addr;
extern unsigned char g_dig1_high_addr;
extern unsigned char g_dig2_high_addr;
extern unsigned char g_dig3_high_addr;
extern unsigned char g_dig4_high_addr;

#ifdef CONFIG_ALI_VOLBAR
extern unsigned int g_gpio_vol_up;
extern unsigned int g_gpio_vol_down;
#endif
...
#else
unsigned long __G_ALI_MM_SUBT_SIZE = 0;
unsigned long __G_ALI_MM_SUBT_START_ADDR = 0;

unsigned long __G_ALI_MM_TTX_SIZE = 0;
unsigned long __G_ALI_MM_TTX_START_ADDR = 0;

unsigned long __G_ALI_MM_TTX_PARAM_BUF_SIZE = 0;
unsigned long __G_ALI_MM_TTX_PARAM_BUF_ADDR = 0;
#endif
...
unsigned long __G_ALI_MM_ALSA_CAPTURE_MEM_SIZE = 0;
unsigned long __G_ALI_MM_ALSA_CAPTURE_START_ADDR = 0;

unsigned long __G_ALI_MM_ALSA_I2SIRX_I2SO_MIX_MEM_SIZE = 0;
unsigned long __G_ALI_MM_ALSA_I2SIRX_I2SO_MIX_START_ADDR = 0;
...
/* gpio i2c */
unsigned int g_gpio_i2c_panel_id = 0xffffffff;
unsigned int g_gpio_i2c_panel_sda = GPIO_PORT_MAX + 1;
unsigned int g_gpio_i2c_panel_scl = GPIO_PORT_MAX + 1;

//panel CH455 and CH454 LED address
unsigned char g_dig0_addr = 0;
unsigned char g_dig1_addr = 0;
unsigned char g_dig2_addr = 0;
unsigned char g_dig3_addr = 0;
unsigned char g_dig4_addr = 0;
unsigned char g_dig0_high_addr = 0;
unsigned char g_dig1_high_addr = 0;
unsigned char g_dig2_high_addr = 0;
unsigned char g_dig3_high_addr = 0;
unsigned char g_dig4_high_addr = 0;

/* volbar */
#ifdef CONFIG_ALI_VOLBAR
unsigned int g_gpio_vol_up = GPIO_PORT_MAX + 1;
unsigned int g_gpio_vol_down = GPIO_PORT_MAX + 1;
#endif
