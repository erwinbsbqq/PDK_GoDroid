...
enum AUDIO_AV_SYNC_MODE
{
    ...
    AUDIO_AV_SYNC_AUDIO,
    AUDIO_AV_SYNC_VIDEO,
    AUDIO_AV_SYNC_EXTERNAL,     /* synchronize to an external clock */
    AUDIO_AV_SYNC_AUDIO_N,      /* sync width audio, using new av sync module */
    AUDIO_AV_SYNC_VIDEO_N,      /* sync width video, using new av sync module */
    AUDIO_AV_SYNC_EXTERNAL_N,   /* sync width external clock, using new av sync module */
};
