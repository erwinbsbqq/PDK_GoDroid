...
#define CORE_ID_REG             __REGALIRAW(0x18000000)
...
#define	REG_MAIN_MBX0_SEND      __REGALIRAW(0x18000200)
#define	REG_MAIN_MBX1_SEND      __REGALIRAW(0x18000204)
#define	REG_MAIN_MBX2_SEND      __REGALIRAW(0x18000208)
#define	REG_MAIN_MBX3_SEND      __REGALIRAW(0x1800020C)

/* mailbox reg for receive */
#define	REG_MAIN_MBX0_RECV      __REGALIRAW(0x18040200)
#define	REG_MAIN_MBX1_RECV      __REGALIRAW(0x18040204)
#define	REG_MAIN_MBX2_RECV      __REGALIRAW(0x18040208)
#define	REG_MAIN_MBX3_RECV      __REGALIRAW(0x1804020C)

/* mailbox interrupt enable register */
#define	REG_MAIN_MBX_ENABLE     __REGALIRAW(0x1800003C)
...
/* interrupt register */
#define	REG_MAIN_MBX_INT        __REGALIRAW(0x18000034)
...
#define	REG_MAIN_SENSE_MBX      __REGALIRAW(0x18000034)
...
/* mailbox reg for send */
#define	REG_SEE_MBX0_SEND       __REGALIRAW(0x18040200)
#define	REG_SEE_MBX1_SEND       __REGALIRAW(0x18040204)
#define	REG_SEE_MBX2_SEND       __REGALIRAW(0x18040208)
#define	REG_SEE_MBX3_SEND       __REGALIRAW(0x1804020C)

/* mailbox reg for receive */
#define	REG_SEE_MBX0_RECV       __REGALIRAW(0x18000200)
#define	REG_SEE_MBX1_RECV       __REGALIRAW(0x18000204)
#define	REG_SEE_MBX2_RECV       __REGALIRAW(0x18000208)
#define	REG_SEE_MBX3_RECV       __REGALIRAW(0x1800020C)

/* mailbox interrupt enable register */
#define	REG_SEE_MBX_ENABLE      __REGALIRAW(0x1804003C)
