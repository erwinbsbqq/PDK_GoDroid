...
*                                                                                                                    *
********************************************************************/
static int __devinit iis_codec_c3701_dev_probe(struct platform_device *pdev)
{
	return snd_soc_register_codec(&pdev->dev,
			&iis_codec_c3701_drv, iis_codec_c3701_dai,  ARRAY_SIZE(iis_codec_c3701_dai));
}

static int __devexit iis_codec_c3701_dev_remove(struct platform_device *pdev)
{
...
static struct platform_driver iis_codec_c3701_dev_driver = {
	...
	.remove		= __devexit_p(iis_codec_c3701_dev_remove),
	.driver		= {
