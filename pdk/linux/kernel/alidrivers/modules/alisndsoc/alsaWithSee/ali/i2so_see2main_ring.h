#ifndef _I2SO_SEE2MAIN_RING_H_
#define _I2SO_SEE2MAIN_RING_H_

#include <linux/kernel.h>
#include <linux/slab.h>

struct i2so_see2main_ring_info
{
...
__s32 i2so_see2main_ring_init(__u8 *buf_base, __u32 buf_len);
__u32 i2so_see2main_ring_read(__u8 * data, __u32 len);
__u32 i2so_see2main_ring_avail(void);
__s32 i2so_see2main_ring_onoff(__u32 onoff);
