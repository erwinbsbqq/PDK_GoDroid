...
//#include <ali_common/ali_smc_common.h>
...
typedef struct _backup_pic_mem_attr_t {
	unsigned long backup_pic_mem_start_addr;
	unsigned long backup_pic_mem_len;		
	unsigned long reserve_backup_pic_mem_bootmem;
} backup_pic_mem_attr_t;
...
typedef struct _board_attr_t {
	...
	//smc_attr_t smc_attr;
    backup_pic_mem_attr_t backup_pic_mem_attr;
} board_attr_t;
...
backup_pic_mem_attr_t * get_backup_pic_mem_attr(void);
#endif
