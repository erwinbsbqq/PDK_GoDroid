...
#define PLL_PM_VALUE_0          (DDR_ALL_END + 4 * 1)
#define PLL_PM_VALUE_1          (DDR_ALL_END + 4 * 2)
#define PLL_PM_VALUE_2          (DDR_ALL_END + 4 * 3)
#define PLL_PM_VALUE_3          (DDR_ALL_END + 4 * 4)
#define PLL_PM_VALUE_4          (DDR_ALL_END + 4 * 5)
#define PLL_PM_VALUE_5          (DDR_ALL_END + 4 * 6)
//PLL_PM_VALUE_5
/* Store the timeout value */



#define PM_SLEEP_TIMEOUT        (DDR_ALL_END + 4 * 7)
#define PM_SLEEP_TIMEOUT_CONST  (DDR_ALL_END + 4 * 8)
#define PM_SLEEP_TIME_CONST     (DDR_ALL_END + 4 * 9)
...
#define KEY_PRESS	    0x44
#define KEY_RELEASE	    0x0c
#define CH455_MODE	    0x01
/* GPIO IIC*/
#define I2C_GPIO_SCL              69
#define I2C_GPIO_SDA		      68
