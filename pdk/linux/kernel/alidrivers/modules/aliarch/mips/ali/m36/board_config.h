...
/* FB3 Size */
#define FB2_VIRTUAL_WIDTH               1280//1920
#define FB2_VIRTUAL_HEIGHT              720//1080
#define FB2_WIDTH                       1280//1920
#define FB2_HEIGHT                      720//1080
#define FB2_BPP                         4// bytes per pixel
...
#define VDEC_RAW_DATA_MEM_SIZE          (VDEC_CMD_QUEUE_MEM_SIZE + VDEC_LAF_FLAG_MEM_SIZE + VDEC_LAF_RW_MEM_SIZE)
...
/* Video VBV
*/
#define __MM_VBV_BUF_START              ((__MM_SEE_PRIVATE_END + 0xFF) & 0xFFFFFF00)
#define __MM_VBV_BUF_END                (__MM_VBV_BUF_START + VDEC_VBV_MEM_SIZE)

/* VDEC RAW Data
*/
#define __MM_VDEC_RAW_DATA_BUF_START    ((__MM_VBV_BUF_END + 0x3FF) & 0xFFFFFC00)
#define __MM_VDEC_RAW_DATA_BUF_END      (__MM_VDEC_RAW_DATA_BUF_START + VDEC_RAW_DATA_MEM_SIZE)

/* AUDIO
*/
#define __MM_AUDIO_ENGINE_START         ((__MM_VDEC_RAW_DATA_BUF_END + 0xFFF) & 0xFFFFF000)
#define __MM_AUDIO_ENGINE_END           (__MM_AUDIO_ENGINE_START + AUDIO_MEM_SIZE)

/* FB3
*/
#define __MM_FB2_MEM_START_1G           (__MM_AUDIO_ENGINE_END)
#define __MM_FB2_MEM_END_1G             (__MM_FB2_MEM_START_1G + FB2_MEM_SIZE)
...
/* Subtitle
*/
#define __MM_SUBT_BUF_START             (__MM_FB2_MEM_END_1G)
...
/* SHARED
*/
#define __MM_SEE_MAIN_SHARED_MEM_START  ((__MM_TTX_PARAM_BUF_END + 0xFFF) & 0xFFFFF000)
#define __MM_SEE_MAIN_SHARED_MEM_END    (__MM_SEE_MAIN_SHARED_MEM_START + SHARED_MEM_SIZE)

/* MCAPI
*/ 
#define __MM_MCAPI_MEM_START            ((__MM_SEE_MAIN_SHARED_MEM_END + 0xFFF) & 0xFFFFF000)
...
** VENC added_by_VicZhang_on_20131111.
*/
#define __MM_VENC_DATA_START            (__MM_DSC_MEM_END)
#define __MM_VENC_DATA_END              (__MM_VENC_DATA_START + ALI_VENC_MEM_SIZE)

/* Video Frame Buffer
*/
#define __MM_VIDEO_BUF_START            ((__MM_VENC_DATA_END + 0xFFF) & 0xFFFFF000)
...
/* VCAP FB
*/
#define __MM_VCAP_FB_START              ((__MM_USER_DATA_START - VCAP_FB_MEM_SIZE) & 0xFFFFF000)
#define __MM_VCAP_FB_END                (__MM_VCAP_FB_START + VCAP_FB_MEM_SIZE) 

/* STILL FB
*/
#define __MM_STILL_FRAME_START          ((__MM_VCAP_FB_START - STILL_FB_MEM_SIZE) & 0xFFFFF000)
...
/* Image Decoder
*/
#define __MM_IMAGE_DECODER_MEM_START    ((__MM_MP_MEM_START - IMAGE_DECODER_MEM_SIZE) & 0xFFFFFF00)
#define __MM_IMAGE_DECODER_MEM_END      (__MM_IMAGE_DECODER_MEM_START + IMAGE_DECODER_MEM_SIZE) 

/* TSG
*/
#define __MM_TSG_MEM_START              ((__MM_IMAGE_DECODER_MEM_START - TSG_MEM_SIZE) & 0xFFFFFF00)
...
#define __MM_FILE_SIGNATURE_TOP_ADDR    (__MM_DECA_DATA_START - __MM_FILE_SIGNATURE_LEN)
#define __MM_FILE_SIGNATURE_END_ADDR    (__MM_FILE_SIGNATURE_TOP_ADDR + __MM_FILE_SIGNATURE_LEN)
#endif

/* TOP and Bottom1
*/
#if (defined CONFIG_FILE_SIGNATURE_ALIASIX)
#define __MM_ALI_PRIVATE_MEM_START1			    ALI_MEMALIGNDOWN(__MM_FILE_SIGNATURE_TOP_ADDR)
#else
#define __MM_ALI_PRIVATE_MEM_START1			    ALI_MEMALIGNDOWN(__MM_DECA_DATA_START)
#endif
#define __MM_ALI_PRIVATE_MEM_END1				ALI_MEMALIGNUP(__MM_VIDEO_BUF_END)
...
/* MALI
*/
#define __MM_MALI_MEM_START_1G          ((__MM_FB_MEM_END_1G + 0xFF) & 0xFFFFFF00)
#define __MM_MALI_MEM_END_1G            (__MM_MALI_MEM_START_1G + MALI_DEDICATED_MEM_SIZE)

/* MALI UMP
*/
#define __MM_MALI_UMP_MEM_START_1G      ((__MM_MALI_MEM_END_1G + 0xFF) & 0xFFFFFF00)
#define __MM_MALI_UMP_MEM_END_1G        (__MM_MALI_UMP_MEM_START_1G + MALI_UMP_MEM_SIZE)

/* TOP and Bottom2
*/
#define __MM_ALI_PRIVATE_MEM_START2_1G  ALI_MEMALIGNDOWN(__MM_FB_MEM_START_1G)  
#define __MM_ALI_PRIVATE_MEM_END2_1G    ALI_MEMALIGNUP(__MM_MALI_UMP_MEM_END_1G)
...
/* MALI
*/
#define __MM_MALI_MEM_START_512M        ((__MM_FB_MEM_END_512M + 0xFF) & 0xFFFFFF00)
#define __MM_MALI_MEM_END_512M          (__MM_MALI_MEM_START_512M + MALI_DEDICATED_MEM_SIZE)

/* MALI UMP
*/
#define __MM_MALI_UMP_MEM_START_512M    ((__MM_MALI_MEM_END_512M + 0xFF) & 0xFFFFFF00)
#define __MM_MALI_UMP_MEM_END_512M      (__MM_MALI_UMP_MEM_START_512M + MALI_UMP_MEM_SIZE)

/* TOP and Bottom2
*/
#define __MM_ALI_PRIVATE_MEM_START2_512M    ALI_MEMALIGNDOWN(__MM_FB_MEM_START_512M)    
#define __MM_ALI_PRIVATE_MEM_END2_512M      ALI_MEMALIGNUP(__MM_MALI_UMP_MEM_END_512M)
