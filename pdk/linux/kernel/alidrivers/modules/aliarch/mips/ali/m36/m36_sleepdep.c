...
static inline void operate_usb(int power_down)
{
    if (power_down)
    {
        __pm_reg_value.usb_pd_b80320f0 = *(unsigned int *)0xb80320f0;
        __pm_reg_value.usb_pd_b80324f0 = *(unsigned int *)0xb80324f0;
        *(unsigned int *)0xb80320f0 |= 0x00010000;
        *(unsigned int *)0xb80324f0 |= 0x00010000;
    }
    else
    {
        *(unsigned int *)0xb80320f0 = __pm_reg_value.usb_pd_b80320f0;
        *(unsigned int *)0xb80324f0 = __pm_reg_value.usb_pd_b80324f0;
    }
}
