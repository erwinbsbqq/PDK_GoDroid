 ...
 *    =======================================================
 *     1.   02.20.2008	Mao Feng	Ver 0.1		Original MAC
 *     2.	04.23.2009				Ver 0.2		Cost Down MAC
 *	   3.	11.18.2009				Ver 0.3		TOE I
 *	   4.	03.24.2010				Ver 0.4		TOE II
 ******************************************************************************/
#ifndef _ALI_ETH_REG_
#define _ALI_ETH_REG_

//#ifndef CONFIG_ALI_TOE2_128M
#define TX_ASYNC_XMIT
//#endif
...
#define TOE2_INTERRUPT_MASK (ISRTxCoeErr|ISRLinkStatus|ISRWatchdog \
		|ISRRxComplete|ISRTxUnderrun|ISRTimer|ISRRxFifoOverflow|ISRRxBufOverflow|ISRTxComplete)
#else
#define TOE2_INTERRUPT_MASK (ISRTxCoeErr|ISRLinkStatus|ISRWatchdog \
...
#define TOE2_INTERRUPT_MASK2 (ISRTxCoeErr|ISRLinkStatus|ISRWatchdog \
		|ISRTxUnderrun|ISRTimer|ISRRxFifoOverflow|ISRRxBufOverflow|ISRRxBufDiscard)
