...
typedef enum _tmTDA18250IFLevel_t
{
    tmTDA18250_IF_Level_2V   = 0,
    tmTDA18250_IF_Level_1V   = 2,
    tmTDA18250_IF_Level_0_5V = 7,
    tmTDA18250_IF_Level_MAX,
} tmTDA18250IF_Level_t, *ptmTDA18250IF_Level_t;
