...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        switch (powerState)
        {
            ...
            case tmddTDA18250_PowerStandbyWithXtalOn:
...
)
{
    ...
    if (err == TM_OK)
    {
        ...
        if (err == TM_OK)
        {
            ...
            uPowerLT = pObj->I2CMap.uBx17.bF.pdLT;
        }
        else
        {
            uPowerState = 0x00;
        ...
        if (err == TM_OK)
        {
            ...
            else if ((uPowerState == 1) && (uPowerLT == 0))
                *pPowerState = tmddTDA18250_PowerStandbyWithLoopThroughOnAndWithXtalOn;
            else if ((uPowerState == 1) && (uPowerLT == 1))
...
/*============================================================================*/
/* FUNCTION:    tmddTDA18250SetRFSW_MTO_LT_RFin                               */
/*                                                                            */
/* DESCRIPTION: Set the LT & MTO connection.                                  */
/*                                                                            */
/* RETURN:      TM_OK if no error                                             */
/*                                                                            */
/* NOTES:       If 1, LT & MTO are connected to 75Ohms LNA                    */
/*============================================================================*/
tmErrorCode_t
tmddTDA18250SetRFSW_MTO_LT_RFin
(
    tmUnitSelect_t  tUnit,      /* I: Unit number */
    UInt8           uValue      /* I: item value  */
)
{
	...
	{
		/* set value */
		pObj->I2CMap.uBx18.bF.RFSW_MTO_LT_RFin = uValue;
