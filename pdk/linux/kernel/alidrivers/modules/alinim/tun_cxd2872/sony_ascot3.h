...
*/
#define SONY_ASCOT3_VERSION       "1.2.1.0"
...
*/
/**
 @brief Use external Xtal. (for CXD2871/2872)
...
/**
 @brief Disable Xtal in Sleep state. (for CXD2871/2872/2875)
...
/**
 @name  Internal RFAGC (overload) setting. (for CXD2871/2872)
...
/**
 @brief Internal loop filter setting. (for CXD2871/2872)
...
/**
 @brief Loop through enable. (for CXD2872)
*/
#define SONY_ASCOT3_CONFIG_LOOPTHRU_ENABLE        0x08000000

/**
 @brief RFIN matching for Power Save state enable (for CXD2871/2872)
...
/**
 @name IF/AGC pin individually setting. (for CXD2871)

       Used if sony_ascot3_adjust_param_t::IFAGCSEL == 0xFF
       Available CXD2871 only.
       CXD2872/2875 only have IF2/AGC2.
*/
/**@{*/
...
/**
 @name IF/AGC pin setting for normal cases. (for CXD2871)
...
/**
 @name  REFOUT setting related macros. (for CXD2871/2872/2875)
...
/**
 @brief Set up the ASCOT3 tuner driver for CXD2875 (ASCOT3R).

        This is the special create function for CXD2875.
...
/**
 @brief Write to GPO0 or GPO1. (for CXD2871/2872)
...
/**
 @brief Set the RF external circuit control pin. (for CXD2871)
        (Set RF_EXT_EN register.)
...
/**
 ...
 @note  Target level of IF signal output (depend on demodulator)
        ...
        (RSSI_IFOUT_TGT(0x79) is not set in sony_ascot3.c.)
...
/**
 @brief RF filter compensation setting for VHF-L band. (for CXD2871/2872)
