...
#ifndef SONY_CXD2872_COMMON_H
#define SONY_CXD2872_COMMON_H
...
#endif
 */
#define SONY_SLEEP(n)   comm_sleep(n)
...
/*------------------------------------------------------------------------------
  Common functions
------------------------------------------------------------------------------*/
int32_t cxd2872_Convert2SComplement(uint32_t value, uint32_t bitlen);
...
//#define SONY_TUNER_TRACE_ENABLE
#ifdef SONY_TUNER_TRACE_ENABLE
/* <PORTING> This is only a sample of trace macro. Please modify is necessary. */
//void sony_trace_log_enter_t(const char* funcname, const char* filename, unsigned int linenum);
//void sony_trace_log_return_t(sony_result_t result, const char* filename, unsigned int linenum);
#define SONY_TRACE_ENTER(func) printk("\n%s,%s,%d\n", __FUNCTION__, __FILE__, __LINE__)
...
/* <PORTING> This is only a sample of trace macro. Please modify is necessary. */
#define SONY_TRACE_I2C_ENTER(func)  printk("[%s]enter:func=%s,line=%d\n",__FILE__,__FUNCTION__,__LINE__)
#define SONY_TRACE_I2C_RETURN(result) \
    SONY_MACRO_MULTILINE_BEGIN \
        printk("leave:filename=%s,line=%d,result=%d\n",__FILE__,__LINE__,result); \ 
        return (result); \
    SONY_MACRO_MULTILINE_END
...
*/
sony_result_t cxd2872_stopwatch_start (sony_stopwatch_t * pStopwatch);
...
/**
 ...
 @return SONY_RESULT_OK is succesful.
*/
sony_result_t cxd2872_stopwatch_sleep (sony_stopwatch_t * pStopwatch, uint32_t ms);
...
*/
sony_result_t cxd2872_stopwatch_elapsed (sony_stopwatch_t * pStopwatch, uint32_t* pElapsed);


#endif /* SONY_CXD2872_COMMON_H */
