...
#define HCDP_MAX_UNITS                          (6)

/* Driver version definition */
#define HCDP_COMP_NUM                           (2) /* Major protocol change - Specification change required */
#define HCDP_MAJOR_VER                          (0) /* Minor protocol change - Specification change required */
#define HCDP_MINOR_VER                          (30) /* Software update - No protocol change - No specification change required */
...
typedef struct _HCDPObject_t 
{
    ...
    HCDP_ExtendSymbolRateMode_t         eExtendedSRMode;
...
extern tmErrorCode_t
iHCDPWait(pHCDPObject_t pObj, UInt32 uTime);
