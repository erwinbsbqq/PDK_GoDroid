...
------------------------------------------------------------------------------*/
#include "sony_math.h"
#define sony_math_log2 cxd2837_math_log2
/*------------------------------------------------------------------------------
 Defines
------------------------------------------------------------------------------*/
...
uint32_t cxd2837_math_log2 (uint32_t x)
{
    uint8_t count = 0;
    uint8_t index = 0;
    uint32_t xval = x;
...
uint32_t cxd2837_math_log10 (uint32_t x)
{
...
uint32_t cxd2837_math_log (uint32_t x)
{
    /* ln (x) = log2 (x) / log2(e) */
