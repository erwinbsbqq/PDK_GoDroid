...
typedef struct sony_i2c_t {
	...
	void *pDemod; //Pointed to this instance of demod.
	uint32_t i2c_type_id; //Ali I2C.
	uint32_t tuner_id;
    /**
...
sony_result_t cxd2837_i2c_TunerGateway(void* nim_dev_priv, uint8_t tuner_address , uint8_t* wdata , int wlen , uint8_t* rdata , int rlen);
