...
#define SAME_TUNER_CONFIG_DVBT_T2
...
#endif
#define CXD2837_LOG_I2C		cxd2837_log_i2c
//#define CXD2837_LOG_I2C(...)	 	do{}while(0)
...
typedef struct sony_demod_t {
	...
	uint8_t t2_signal;        //0:DVB-T signal, 1:DVB-T2 signal. 
	...
	uint8_t t2_profile;	
	uint8_t search_t2_only;

	LOG_STRING_FUNCTION fn_output_string;
	char *output_buffer;
    pfn_nim_reset_callback 	     m_pfn_reset_cxd2837;
...
/**
 ...
 @return SONY_RESULT_OK if successful.
*/
sony_result_t cxd2837_demod_TuneEnd (sony_demod_t * pDemod);
...
*/
sony_result_t cxd2837_demod_SetConfig (sony_demod_t * pDemod, 
...
/**
 ...
 @return SONY_RESULT_OK if successful.
*/
sony_result_t cxd2837_demod_I2cRepeaterEnable (sony_demod_t * pDemod, 
                                            uint8_t enable);
