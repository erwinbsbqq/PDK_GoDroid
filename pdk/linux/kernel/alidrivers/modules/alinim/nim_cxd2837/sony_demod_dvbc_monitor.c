/*------------------------------------------------------------------------------
  ...
  Last Updated  : $Date:: 2013-07-15 11:27:50 #$
  File Revision : $Revision:: 7209 $
------------------------------------------------------------------------------*/
...
#define sony_math_log   cxd2837_math_log
...
*/
sony_result_t sony_demod_dvbc_monitor_Quality (sony_demod_t * pDemod, uint8_t * pQuality)
{
    uint32_t ber = 0;
    int32_t snr = 0;
    int32_t snRel = 0;
