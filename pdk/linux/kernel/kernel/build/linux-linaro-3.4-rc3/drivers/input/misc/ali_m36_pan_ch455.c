...
#define DIG1_ADDR	0x6e		/* 0x6a */
#define DIG2_ADDR	0x6c
#define DIG3_ADDR	0x6a		/* 0x6e */
...
/* 	ch455_i2c_info :
	...
	byte3, reserve; 
*/
static unsigned int  ch455_i2c_info = 1;
...
static int ch455_key_mapping(unsigned long phy_code)
{
	...
	if(NULL==g_ch455_key_map.map_entry)
	{		
		return -1;		
	}
		...
		size_t count, loff_t *ppos)
{
	...
	u8 flag=0;
	char *data;
	u8 addr[4]={DIG0_ADDR, DIG1_ADDR, DIG2_ADDR, DIG3_ADDR};
	s32 i = 0, num = -1;
