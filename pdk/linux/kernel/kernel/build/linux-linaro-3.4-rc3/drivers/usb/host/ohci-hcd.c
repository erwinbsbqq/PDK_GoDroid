...
static int ohci_init (struct ohci_hcd *ohci)
{
	...
	if (patch_s3921)
	{
    //#ifdef CONFIG_PATCH_ALI_S3921_OHCI
		ohci->hcca_dma &= 0x7fffffff;    
    //#endif
  }
...
#ifdef CONFIG_USB_OHCI_ALI_M3921
#include "ohci-ali.c"
#define PLATFORM_DRIVER		ohci_hcd_ali_driver
#endif
