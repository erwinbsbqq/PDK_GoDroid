...
static struct s3921_dvfs s3921_dvfs_table_w[] = 
{
...
static struct s3921_dvfs s3921_dvfs_table_t[] = 
{
	[0] = { 900000,  910000 },            /*200M */
	[1] = { 900000,  910000 },            /*225M */
	[2] = { 900000,  910000 },            /*250M */
...
static struct s3921_dvfs s3921_dvfs_table_b[] = 
{
	[0] = { 900000,  910000 },            /*200M */
	[1] = { 900000,  910000 },            /*225M */
	[2] = { 900000,  910000 },            /*250M */
...
static struct s3921_dvfs *s3921_dvfs_table =  s3921_dvfs_table_w;
				      ...
				      unsigned int relation)
{
    ...
    {
        /* The  regulator table type is "W" */
        s3921_dvfs_table = s3921_dvfs_table_w;
    }
     else if (S3921_CPU_REGULATOR_TABLE_T == ui_cpu_regulator_table_type)
    {
        /* The  regulator table type is "T" */
        s3921_dvfs_table = s3921_dvfs_table_t;
    }
    else
    {
        /* The  regulator table type is "B" */
        s3921_dvfs_table = s3921_dvfs_table_b;        
    }
...
*/
    ...
    if (g_ali_cpufreq_debug_ctrl != 0)
    {
        ...
        printk(KERN_ALERT"PL310 CLK = %lukHz,  L2 TAG RAM CLK = %lukHz, L2 DATA RAM CLK = %lukHz, L2 AXI Master CLK = %lukHz \n" 
        ...
        printk(KERN_ALERT"PL310 clock ratio = %lu,  L2 TAG RAM clock ratio = %lu, L2 DATA RAM clock ratio = %lu, L2 AXI Master clock ratio = %lu \n\n" 
...
{
    unsigned int ul_pm_counter = 0;
    int ret = 0;
    if (s != NULL) 
    {        
        ret = sscanf(s, "%u", &ul_pm_counter);
