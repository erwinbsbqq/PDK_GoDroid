...
export MIPS_TOOLCHAIN = arm-linux-gnueabi
endif
...
export IMAGES_DIR = $(SRC_DIR)/images
...
# kernel subdir
export LINUX_KERNEL_SUBDIR = $(KERNEL_DIR)/$(LINUX_KERNEL_VER)
...
export BINTOOLS_PF_SUBDIR = $(PLATFORM_DIR)/bin_tools
