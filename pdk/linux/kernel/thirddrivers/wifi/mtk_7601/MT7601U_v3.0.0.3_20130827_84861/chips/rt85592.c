...
#if 0
	/* Driver should toggle RF R02 bit7(rescal_en)  for initiate calbration */
	RT30xxReadRFRegister(pAd, RF_R02, &rf_val);
	rf_val = ((rf_val & ~0x80) | 0x80); /* rescal_en (initiate calibration) */
	RT30xxWriteRFRegister(pAd, RF_R02, rf_val);
	RTMPusecDelay(1000);
#endif
