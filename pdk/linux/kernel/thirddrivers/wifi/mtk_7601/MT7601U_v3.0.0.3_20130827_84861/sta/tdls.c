	...
	IN	PSTRING			arg)
{
	...
	if (pAd->StaCfg.TdlsInfo.bTDLSCapable)
			pAd->StaCfg.WfdCfg.nPC = WFD_PC_TDLS;
	else
			pAd->StaCfg.WfdCfg.nPC = WFD_PC_P2P;
#endif /* WFD_SUPPORT */
    ...
    IN ULONG            DataByteCount)
{
    ...
    DBGPRINT(RT_DEBUG_INFO, ("TDLS_CheckTDLSframe ===> \n"));
...
#ifdef RELEASE_EXCLUDE
	DBGPRINT(RT_DEBUG_INFO, ("TDLS <=== TDLS_CheckTDLSframe \n"));
#endif // RELEASE_EXCLUDE //
