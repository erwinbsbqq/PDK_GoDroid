	...
	else
	{
		...
		else
		{
			...
			if (pPeerSsid)
			{
				...
				PBSS_ENTRY	pBss = &pAd->ScanTab.BssEntry[ApIdx];
				...
				DBGPRINT(RT_DEBUG_TRACE, ("IWSC_ScanDoneAction:: allocate memory fail!!\n"));
		}
#endif
	}
	...
	*/
...
#endif
	{
		...
		*/
		...
		DBGPRINT(RT_DEBUG_TRACE, ("Ignore this Action Frame!(%d, %d)\n", pIWscInfo->PeerDialogToken, Token));
#endif
	DBGPRINT(RT_DEBUG_TRACE, ("<----- IWSC_PeerAction\n"));
}
