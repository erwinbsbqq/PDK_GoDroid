...
/*
	...
	========================================================================
*/
INT ral_andes_erasefw(RTMP_ADAPTER *pAd)
{
	UINT32 i, val = 0;
	ULONG FileLength;

	FileLength = sizeof(AndesFirmwareImage);
	...
	*/
	...
	RTMP_IO_WRITE32(pAd, COM_REG0, 0);
	RTMP_IO_WRITE32(pAd, RESET_CTL, 0x200);
	
	for(i = 0; i < FileLength; i += 4)
		RTMP_IO_WRITE32(pAd, ANDES_FIRMWARE_IMAGE_BASE + i, 0);
...
NDIS_STATUS PCILoadFirmwareToAndes(RTMP_ADAPTER *pAd)
{
	...
	UINT32 ILMLen, DLMLen, FWVersion;
