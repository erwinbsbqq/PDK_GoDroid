...
HAS_SONY_BBP_SUPPORT=n
HAS_SEPARATE_PROFILE_SUPPORT=n
endif
...
# for custom feature option
HAS_HE_BD_GG_SUPPORT=n
HAS_P2P_CLIENT_DISCOVERY_REMOVE=n
...
HAS_P2P_CHANNEL_LIST_SEPARATE=n
#endif // P2P_SUPPORT //
...
HAS_WIFI_P2P_DEVICENAME_IN_PERSISTAB=n
...
HAS_P2P_AUTO_CHANNEL_SUPPORT=y
HAS_GET_P2PGO_LINKED_DEVICE=y
endif
...
#For SONY 7601 nosie endurance
ifeq ($(HAS_SONY_BBP_SUPPORT),y)
WFLAGS += -DSONY_BBP_SUPPORT
endif

ifeq ($(HAS_SEPARATE_PROFILE_SUPPORT),y)
WFLAGS += -DSEPARATE_PROFILE_SUPPORT
endif
...
ifeq ($(HAS_WIFI_P2P_DEVICENAME_IN_PERSISTAB),y)
WFLAGS += -DWIFI_P2P_DEVICENAME_IN_PERSISTAB
endif
...
ifeq ($(HAS_HE_BD_GG_SUPPORT),y)
WFLAGS += -DHE_BD_GG_SUPPORT
endif

ifeq ($(HAS_P2P_CLIENT_DISCOVERY_REMOVE),y)
WFLAGS += -DP2P_CLIENT_DISCOVERY_REMOVE
endif
...
#ifdef ETH_CONVERT_SUPPORT
ifeq ($(HAS_ETH_CONVERT_SUPPORT), y)
WFLAGS += -DETH_CONVERT_SUPPORT  -DMAT_SUPPORT -DIP_ASSEMBLY
endif
#endif // ETH_CONVERT_SUPPORT //
...
#ifdef P2P_SUPPORT
ifeq ($(HAS_P2P_SUPPORT),y)
WFLAGS += -DP2P_SUPPORT -DAPCLI_SUPPORT -DMAT_SUPPORT -DAP_SCAN_SUPPORT -DSCAN_SUPPORT -DP2P_APCLI_SUPPORT -DCONFIG_AP_SUPPORT -DCONFIG_APSTA_MIXED_SUPPORT -DUAPSD_SUPPORT -DMBSS_SUPPORT -DIAPP_SUPPORT -DDOT1X_SUPPORT -DWSC_AP_SUPPORT -DWSC_STA_SUPPORT -DENQUEUE_WPS_EAPOL_START
endif

ifeq ($(HAS_GET_P2PGO_LINKED_DEVICE),y)
WFLAGS += -DGET_P2PGO_LINKED_DEVICE
endif
...
ifeq ($(HAS_P2P_CHANNEL_LIST_SEPARATE),y)
WFLAGS += -DP2P_CHANNEL_LIST_SEPARATE
endif
#endif // P2P_SUPPORT //
...
ifeq ($(HAS_P2P_AUTO_CHANNEL_SUPPORT),y)
WFLAGS += -DP2P_AUTO_CHANNEL_SUPPORT
endif
...
ifeq ($(PLATFORM),ALI_TPE_MIPS_LINUX)
     EXTRA_CFLAGS += $(WFLAGS) -O2 -DLINUX -DCONFIG_ALI_PATCH -I$(RT28xx_DIR)/include
     #EXTRA_CFLAGS += $(WFLAGS) -O2 -DLINUX -DCONFIG_ALI_PATCH -I$(RT28xx_DIR)/include 
     export EXTRA_CFLAGS
endif

ifeq ($(PLATFORM),ALI_ZHA_MIPS_LINUX)
     EXTRA_CFLAGS += $(WFLAGS) -O2 -DLINUX -DCONFIG_ALI_PATCH -DCONFIG_ALI_ZHA_MAC_PATCH -DCONFIG_ZHA_WPA_PATCH -I$(RT28xx_DIR)/include -I/home/zmiao/work4/3701C/ALI_SDK5.0/rabbit/kernel/alidrivers/include
 #    EXTRA_CFLAGS += $(WFLAGS) -O2 -DLINUX -DCONFIG_ALI_PATCH -DCONFIG_ALI_ZHA_MAC_PATCH -DCONFIG_ZHA_WPA_PATCH
     export EXTRA_CFLAGS
endif
