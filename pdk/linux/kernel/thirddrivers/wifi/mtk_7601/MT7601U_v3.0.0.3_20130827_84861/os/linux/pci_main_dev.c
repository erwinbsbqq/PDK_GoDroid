...
#if 0 /* os abl move to os/linux/rt_rbus_pci_drv.c */
...
static struct pci_device_id rt2860_pci_tbl[] __devinitdata =
{
...
#endif /* RT3290 */
#ifdef RT6590
	{PCI_DEVICE(NIC_PCI_VENDOR_ID, NIC6590_PCIe_DEVICE_ID)},
#endif /* RT6590 */
#ifdef RT8592
	...
	{PCI_DEVICE(0x1800, NIC6590_PCIe_DEVICE_ID)},
	{PCI_DEVICE(NIC_PCI_VENDOR_ID, NIC6590_PCIe_DEVICE_ID)},
...
#if 0 /* move to RtmpOSTaskInit() */
{
	...
	init_waitqueue_head(pList->cmdQTask.kthread_q);
#ifdef WSC_INCLUDED
	init_waitqueue_head(pList->wscTask.kthread_q);
#endif /* WSC_INCLUDED */
}
