...
#if 0
#define RTMP_DRIVER_CFG80211_INIT(__pAd, __pDev)							\
{																			\
	RT_CMD_CFG80211_CONFIG __Config, *__pConfig = &__Config;				\
	__pConfig->pCfgDev = &(__pDev->dev);									\
	__pConfig->CFG80211_Register = CFG80211_Register;						\
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_CFG80211_CFG_INIT, 0, __pConfig, 0);\
}
#endif
...
#define RTMP_DRIVER_ADAPTER_START_UP_TEST(__pAd, __flag)								\
	RTMP_COM_IoctlHandle(__pAd, NULL, CMD_RTPRIV_IOCTL_ADAPTER_START_UP_TEST, 0,  __flag, 0)
