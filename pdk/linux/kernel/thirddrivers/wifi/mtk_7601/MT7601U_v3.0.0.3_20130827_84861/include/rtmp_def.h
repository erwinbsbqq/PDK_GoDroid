...
*/
#define MGMT_DMA_BUFFER_SIZE    3840	/*2048 * mzhu*/
...
#define REGION_38_A_BAND                  38 /* 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 149, 153, 157, 161, 165 */
#define REGION_MAXIMUM_A_BAND             38
#ifdef P2P_SUPPORT
#ifdef P2P_CHANNEL_LIST_SEPARATE
#define REGION_DISABLE_A_BAND             127
