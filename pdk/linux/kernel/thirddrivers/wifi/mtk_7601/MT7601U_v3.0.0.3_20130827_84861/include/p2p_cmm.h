...
#define MAX_P2P_TABLE_SIZE		9 /*  Save Presistent entry */
#else
...
/*	P2P_EVENTQUEUE_STRUCT	P2pEventQueue; */
	...
	BOOLEAN				bChannelListSeparate; /* P2P channel list separate function enable/disable, default is disable */
...
#ifdef HE_SUPPORT
	BOOLEAN					bInsPerTable; /* Note this flag was not used. This flag was moved to _RT_P2P_TABLE */
	UCHAR					StatusCode;
#endif /* HE_SUPPORT */
...
#ifdef RT_P2P_SPECIFIC_WIRELESS_EVENT
#ifdef HE_SUPPORT
	BOOLEAN						bInsPerTable; /* flag indicating if the persistent table has an update */
#endif
#endif
...
typedef struct _RT_P2P_DEV_FOUND
{
	...
	WFD_COUPLED_SINK_INFO	coupled_sink_info;
#endif /* WFD_SUPPORT */
...
#ifdef HE_SUPPORT
typedef struct _RT_P2P_FAIL_STATUS_CODE
{
	UCHAR addr[MAC_ADDR_LEN];
	UCHAR rv;
} RT_P2P_FAIL_STATUS_CODE, *PRT_P2P_FAIL_STATUS_CODE;
#endif /* HE_SUPPORT */
