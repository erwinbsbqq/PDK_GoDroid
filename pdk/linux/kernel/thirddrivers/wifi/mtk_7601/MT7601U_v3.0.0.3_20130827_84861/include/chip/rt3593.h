...
#ifdef RTMP_MAC_PCI
#define EEPROM_DEFAULT_FILE_PATH                     "/tmp/HMC_RT3593_PCIe_3T3R_V1_3.bin"
#define RF_OFFSET					0x48000
#endif /* RTMP_MAC_PCI */
#endif /* RTMP_FLASH_SUPPORT */


// TODO: shiang-6590,  marked it and check if we still need those code segments.
#if 0
/* for 3*3 related */
