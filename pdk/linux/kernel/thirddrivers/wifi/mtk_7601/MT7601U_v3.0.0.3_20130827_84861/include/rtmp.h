...
typedef struct _MAC_TABLE_ENTRY {
	...
	UCHAR EnqueueStartForWSCTimerRunning;	/* Enqueue EAPoL-Start for triggering WSC SM */
	RALINK_TIMER_STRUCT EnqueueStartForWSCTimer;	/* A timer which enqueue EAPoL-Start for triggering WSC SM */
...
/*==================================================== */
	...
	*/
	...
	UCHAR DMSSupport;
	BOOLEAN Beclone;
	/*make sure packet be clone once */
/*	UCHAR		DMSIDcount; */
/*	UCHAR		DMSID[WNMMAX_TCLAS]; */
/*	UINT32		DMSID_DestIP[WNMMAX_TCLAS]; */
#endif /* DOT11V_WNM_SUPPORT */
...
#ifdef GET_P2PGO_LINKED_DEVICE//def LW_TEST
	//USHORT LinkedLegacyOnGo;
	//USHORT LinkedP2pOnGo;
	USHORT LinkedP2p0DevNumber;
#endif
#ifdef CONFIG_STA_SUPPORT
...
#if 0 /* os abl move to rt_os_net.h */
