...
CH_DESC Country_Region38_ChDesc_5GHZ[] =
{
	{36, 4, CHANNEL_PASSIVE_SCAN},
	{52, 4, CHANNEL_PASSIVE_SCAN},
	{100, 11, CHANNEL_PASSIVE_SCAN},
	{149, 5, CHANNEL_PASSIVE_SCAN},
	{}
};
...
#endif // CONFIG_SAMSUNG_REGULATORY_SUPPORT //
	/* only for HE SONY BD, set all 5G channel to passive scan */
	{REGION_38_A_BAND, Country_Region38_ChDesc_5GHZ},
	{}
};
