	...
	IN PRTMP_ADAPTER pAd)
{
	...
	if (i >= 50)
	{
		DBGPRINT(RT_DEBUG_ERROR, ("WoW:MAC TX  keeps busy, MAC_STATUS_CFG = 0x%x.  return on AsicRadioOff ()\n",MACValue));
	}
	...
	if (i >= 50)
	{
		DBGPRINT(RT_DEBUG_ERROR, ("WoW:MAC RX  keeps busy, RXQ_STA = 0x%x.	return on AsicRadioOff ()\n",(MACValue & 0x00FF0000)));
	}
	...
	if (pAd->StaCfg.AuthMode >= Ndis802_11AuthModeWPAPSK)
	{
		...
		DBGPRINT(RT_DEBUG_TRACE,("	Key = %02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x:%02x\n",
		sec_cfg.PTK[0],sec_cfg.PTK[1],sec_cfg.PTK[2],sec_cfg.PTK[3],sec_cfg.PTK[4],sec_cfg.PTK[5],sec_cfg.PTK[6],sec_cfg.PTK[7],sec_cfg.PTK[8],sec_cfg.PTK[9],sec_cfg.PTK[10],sec_cfg.PTK[11],sec_cfg.PTK[12],sec_cfg.PTK[13],sec_cfg.PTK[14],sec_cfg.PTK[15]));
