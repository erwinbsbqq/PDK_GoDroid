...
static patch_info patch_table[] = {
    { 0x8821, 0x8821, "rtk8821a", "rtk8821_bt_config", NULL, 0 },  //Rtl8821AE
    { 0x0821, 0x8821, "rtk8821a", "rtk8821_bt_config", NULL, 0 },  //Rtl8821AU
    { 0xb720, 0x8723, "rtk8723b", "rtk8723_bt_config", NULL, 0 },  //Rtl8723BU
    { 0xb72A, 0x8723, "rtk8723b", "rtk8723_bt_config", NULL, 0 },  //Rtl8723BU
    { 0xb728, 0x8723, "rtk8723b", "rtk8723_bt_config", NULL, 0 },  //Rtl8723BE for LC
    { 0xb723, 0x8723, "rtk8723b", "rtk8723_bt_config", NULL, 0 },  //Rtl8723BE
    { 0, 0x1200, "rtk8723a", "rtk8723_bt_config", NULL, 0 } //Rtl8723AU & Rtl8723AE
};
            ...
            loff_t       *pos_p)
{
    ...
    #if 0
    /* According to xRealtek_Android4.2_USB_driver_Guide_atmel_20130614.pdf
     * "If the USB DMA requires 4 bytes alignment (like Rockchip platform)"
     * Added by Jinang.chu, date:2014.04.10
	*/
    skb_reserve(skb, -1); 
    #endif
