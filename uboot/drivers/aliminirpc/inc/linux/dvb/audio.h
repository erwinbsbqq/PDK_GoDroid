...
#define AUDIO_DECA_IO_COMMAND_ADV               _IOWR('o', 34, struct ali_audio_rpc_pars)
#define AUDIO_SND_IO_COMMAND_ADV               _IOWR('o', 35, struct ali_audio_rpc_pars)
#define AUDIO_DECA_SET_DBG_LEVEL              _IO('o', 36)
#define AUDIO_SND_SET_DBG_LEVEL              _IO('o', 37)

#define AUDIO_SND_GET_STC               _IO('o', 38)
#define AUDIO_SND_SET_STC               _IO('o', 39)
#define AUDIO_SND_PAUSE_STC               _IO('o', 40)
#define AUDIO_SND_STC_INVALID               _IO('o', 41)
#define AUDIO_SND_STC_VALID               _IO('o', 42)
#define AUDIO_SND_SET_SUB_BLK        _IO('o', 43)

#define AUDIO_RPC_CALL_ADV       _IO('o', 44)
#define AUDIO_SND_START _IO('o', 45)
#define AUDIO_SND_STOP _IO('o', 46)
#define AUDIO_DECA_PROCESS_PCM_SAMPLES _IO('o', 47)
#define AUDIO_DECA_PROCESS_PCM_BITSTREAM _IO('o', 48)


#define AUDIO_SET_CTRL_BLK_INFO _IOW('o',49,ali_audio_ctrl_blk)
#endif /* _DVBAUDIO_H_ */
