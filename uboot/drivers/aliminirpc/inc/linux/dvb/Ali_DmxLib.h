...
#include <linux/dvb/Ali_DmxLibInternal.h>
/*! @addtogroup dmxlib
 *  @{
 */
...
#define ALI_DMX_TS_STREAM_MAX_PID_CNT 96 //!<一个TS stream最多可以同时收取的邋TS PID个数，请勿改动。
...
{    
    ...
    ALI_DMX_INPUT_PORT_SPI2B_0 = 0x8,//!<保留.
    ALI_DMX_INPUT_PORT_SPI2B_1 = 0x9,//!<保留.
...
struct Ali_DmxSrcCtrlStreamParam
{
    ...
    UINT32                     InputPortAttr;//!<硬DMX的数据源端口的控制寄存器配置，请参考硬件TSI SPEC。
