...
#define M3503 0x3503
    ...
    #define SOC_GPIO_EN_CTRL_REG1           0X430
	#define SOC_GPIO_EN_CTRL_REG2           0X434
	#define SOC_GPIO_EN_CTRL_REG3           0X438
	#define SOC_GPIO_EN_CTRL_REG4           0X43C
   ...
   #define M3921_C							   0x1 // C3921
    ...
    #define PHYS_SOC_BASE_ADDR          ALI_SOC_BASE
