...
#define STB_PART_MAX_CHUNK_NUM 0x20
static unsigned long chunk_start = 0xafc00000;
static unsigned long chunk_end = 0xafc00000 + 0x100000;
...
UINT32 chunk_id_check(unsigned long *chid, unsigned long pointer)
{
	...
	data_id  = fetch_long((UINT32)pointer + CHUNK_ID);
