...
#if defined(ETH_MANUAL_START)
DECLARE_GLOBAL_DATA_PTR;

int do_eth(cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
	char *cmd;
	...
	if (strcmp(cmd, "up") == 0) 
       ...
       {
              eth_halt();
              //TODO: more thing to do. (current still can ping after 'eth down')
		return 0;
	}
