...
struct net_device
{
	...
	int (*attach) (void);
	int (*detach) (struct net_device *);
	
	int (*open) (struct net_device *, void (*callback) (UINT32, UINT32));
	int (*close) (struct net_device *);
	int (*ioctl) (struct net_device *, UINT32, UINT32);

	int (*send_packet) (struct net_device *, void *, UINT16);
	void (*nd_callback) (UINT32, UINT32);
	
	int (*get_info) (struct net_device *, UINT32, void *);
	int (*set_info) (struct net_device *, UINT32, void *);
};
...
int net_open(struct net_device *dev, void (*callback) (UINT32, UINT32));
int net_close(struct net_device *dev);
int net_io_ctl(struct net_device *dev, UINT32, UINT32);

int net_send_packet (struct net_device *dev, void *buf, UINT16 len);

int net_get_info(struct net_device *dev, UINT32 info_type, void *info_buf);
int net_set_info(struct net_device *dev, UINT32 info_type, void *info_buf);
