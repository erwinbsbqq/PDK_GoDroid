...
void board_init_f(ulong bootflag)
{
	...
	serial_puts("U-boot booting, please wait about 5 seconds...\n");
...
void board_init_r(gd_t *id, ulong dest_addr)
{
	...
	bootstage_mark_name(BOOTSTAGE_ID_START_UBOOT_R, "board_init_r");
       ...
       //__asm__ __volatile__(".word 0xeafffffe");
...
# endif /* CONFIG_SYS_FLASH_CHECKSUM */
    ...
    if(get_parameter_from_bl(0, NULL, t_param) != RET_SUCCESS)
    {
        printf("%s: get_paramter_from_bl error\n", __FUNCTION__);
        goto reboot;
    }

//	load_kernel();
	 load_uboot_see(t_param->see_len);
...
/**************************End:PM Value****************************/
    ...
    set_gptparts_emmc();
   	...
   	if(set_mac() != 0)
        goto reboot;
	if(set_boardinfo(0) != 0)
        goto reboot;
	ali_as_uboot_main(t_param);
