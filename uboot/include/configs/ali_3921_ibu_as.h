...
/* ali dirver*/
#define CONFIG_ALI_CHIP
#define CONFIG_ALI_GLOBE
#define CONFIG_ALI_HLD
#define CONFIG_ALI_RSA
#define CONFIG_ALI_CHUNK
#define CONFIG_ALI_STO
#define CONFIG_ALI_NOR_FLASH
...
#define CONFIG_RPC_HLD_DSC
#define CONFIG_RPC_HLD_CRYPTO
