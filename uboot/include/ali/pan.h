...
#define PAN_ESC_CMD_LBD_MAIL 6           /* NEW MAIL  LED*/
#define PAN_ESC_CMD_LBD_WIFI 7           /* WIFI ON OFF  LED*/
...
struct pan_hw_info			/* Total 16 bytes */
{
	...
	UINT8					rsvd_bits:6;	/* in M3101: 0:show time,1:show "off ",2:show blank, 3:show " off"*/
	/* Offset 3: */
	UINT8 					rsvd_byte;	/* Reserved for alignment 0: normal 1: GPIO control LED*/
	...
	UINT32	(*hook_show)(struct pan_device *dev, char *data, UINT32 len);
    //60
    UINT32	p_seg;                          /* pointer for struct pan_gpio_info seg[8] add on 2011-10-26, to support GPIO Bus panel*/
    //64
} __attribute__((packed));
#endif
