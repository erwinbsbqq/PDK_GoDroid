...
#if ((defined HDTV_SUPPORT) || ((SYS_CHIP_MODULE == ALI_S3602) && (SYS_CPU_MODULE == CPU_M6303) && (SYS_PROJECT_FE==PROJECT_FE_DVBT || defined(M3105_CHIP))))//for 3105 or M3105D+3501
...
#define VDEC_IO_DROP_FREEPIC_THRES_BEFORE_SHOW			(VDEC_IO_ELE_BASE + 0x0D)
